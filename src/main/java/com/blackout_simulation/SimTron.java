package com.blackout_simulation;
...
public class SimTron extends Application {
    ...
    public void goScene(String view) throws IOException {
        ...
        try{
            FXMLLoader loader = new FXMLLoader(SimTron.class.getResource("/fxml/" + view + ".fxml"));
