...
public class SolarPlant extends RenewablePlant {
    ...
    private static final LocalTime AVAILABLE_FROM_TIME = LocalTime.of(7, 0, 0);
    private static final LocalTime AVAILABLE_TO_TIME = LocalTime.of(18, 59, 59);
    ...
    private static final String TYPE = "Solar";

    public SolarPlant(String name, double latitude, double longitude, String city, double maxCapacityMW, double efficiency) throws PowerPlantException, LocationException {
